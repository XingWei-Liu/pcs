Pcs = Ember.Application.createWithMixins({
  ...
  return_resource: function() {
    return(translate("Resource"));
  }.property("available_features", "pcsd_capabilities"),
  
  return_fence: function() {
    return(translate("Fence Device"));
  }.property("available_features", "pcsd_capabilities"),
  
  return_required_args: function() {
    return(translate("Required Arguments"));
  }.property("available_features", "pcsd_capabilities"),

  return_optional_args: function() {
    return(translate("Optional_Arguments"));
  }.property("available_features", "pcsd_capabilities"),

  return_advanced_args
  : function() {
    return(translate("Advanced Arguments"));
  }.property("available_features", "pcsd_capabilities"),

  return_deprecated_args: function() {
    return(translate("deprecated_args"));
  }.property("available_features", "pcsd_capabilities"),
...
Pcs.UtilizationTableComponent = Ember.Component.extend({
  ...
  actions: {
    ...
    add: function(form_id) {
      ...
      if (name == "") {
        alert(translate("Name of utilization attribute should be non-empty string."));
      }
      var value = $(id + " input[name='new_utilization_value']").val().trim();
      if (!is_integer(value)) {
        alert(translate("Value of utilization attribute has to be integer."));
        return;
      }
      set_utilization(
        this.type,
...
Pcs.ResourceAgentParameter = Ember.Object.extend({
  ...
  description: function() {
    ...
    if (def_val) desc.push(translate("Default value: ") + def_val);
...
Pcs.Setting = Ember.Object.extend({
  ...
  description: function() {
    ...
    desc += "<br><br>";
    desc += $("<div>").text(translate("Default value: ") + self.get("default")).html();
    return desc;
...
Pcs.Cluster = Ember.Object.extend({
  ...
  quorum_show: function() {
    if (this.get('status') == "unknown") {
      return "<span style='color:orange'>(" + translate("quorate unknown") +")</span>";
    } else if (!this.get('quorate')) {
      return "<span style='color: red'>(" + translate("doesn't have quorum") + ")</span>";
    } else {
      return "";
    }
